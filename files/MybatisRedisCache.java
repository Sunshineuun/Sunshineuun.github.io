...
public class MybatisRedisCache
    ...
    private static final Logger logger =
        LoggerFactory.getLogger(MybatisRedisCache.class);

    private static JedisConnectionFactory jedisConnectionFactory;

    static void setJedisConnectionFactory(
    ...
    public Object getObject(Object key) {
        ...
        try {
            ...
            //利用其反序列化方法获取值
            result = serializer
                .deserialize(connection.get(serializer.serialize(key)));
        } catch (JedisConnectionException e) {
            e.printStackTrace();
        } finally {
            if (connection != null) {
